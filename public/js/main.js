...
exports.default = {
    ...
    computed: {
        submit_button_text: function submit_button_text() {
            if (this.sending) {
                return '.';
            } else {
                return 'Subscribe';
    ...
    methods: {
        ...
        onCancelForm: function onCancelForm(e) {
            e.preventDefault();
            this.closeModal();
        },
    ...
    events: {
        'external-modal-open': function externalModalOpen() {
            this.openModal();
        }
    }
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/Users/jalvarado91/Code/mangohacks.com/resources/assets/js/components/PreRegisterModal.vue"
  if (!module.hot.data) {
...
var _PreRegisterModal = require('./components/PreRegisterModal.vue');

var _PreRegisterModal2 = _interopRequireDefault(_PreRegisterModal);
...
new Vue({
    ...
    methods: {
        formatParseDate: function formatParseDate(parseDate) {
    ...
    ready: function ready() {
        ...
        query.get("lFY2XFA6e8", {
            success: function success(countdownItem) {
...
},{"./components/PreRegisterModal.vue":28,"moment":1,"vue":27,"vue-resource":16}]},{},[29]);
